              ...
              <div class="table-responsive">
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                  ...
                  <tbody style="text-align: center;">
                    ...
                    <tr>
                      <td>{{$catergory->id}}</td>
                     <td><a href="{{route('categories.show'}}" style="color: black">{{$catergory->name}}</a>
                      {{-- <td> --}}
                        {{-- <button class="btn btn-primary editcategory" title ="{{"Sửa"." ".$value->name}}"  data-toggle="modal" data-target="#edit" type="button" data-id="{{ $value->id }}" ><i class="fas fa-edit"></i>
                            </button>
